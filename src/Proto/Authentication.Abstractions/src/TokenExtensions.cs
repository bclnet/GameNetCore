...
namespace Contoso.GameNetCore.Authentication
{
    ...
    public static class AuthenticationTokenExtensions
    {
        ...
        public static Task<string> GetTokenAsync(this IAuthenticationService auth, ProtoContext context, string tokenName)
        ...
        /// <param name="tokenName">The name of the token.</param>
        /// <returns>The value of the token.</returns>
        public static async Task<string> GetTokenAsync(this IAuthenticationService auth, ProtoContext context, string scheme, string tokenName)
        {
            if (auth == null)
