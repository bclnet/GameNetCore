...
namespace Contoso.GameNetCore.GameSockets.Test
{
    public class SendReceiveTests
    {
        ...
        public async Task ClientToServerTextMessage()
        {
            ...
            await pair.ClientSocket.SendAsync(new ArraySegment<byte>(sendBuffer), GameSocketMessageType.Text, endOfMessage: true, cancellationToken: CancellationToken.None);
        ...
        public async Task ClientToServerBinaryMessage()
        {
            ...
            await pair.ClientSocket.SendAsync(new ArraySegment<byte>(sendBuffer), GameSocketMessageType.Binary, endOfMessage: true, cancellationToken: CancellationToken.None);
