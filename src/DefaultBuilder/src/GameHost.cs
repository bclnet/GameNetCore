...
{
    /// <summary>
    /// Provides convenience methods for creating instances of <see cref="IGameHost"/> and <see cref="IGameHostBuilder"/> with pre-configured defaults.
    /// </summary>
    public class GameHost
    {
        ...
        /// <returns>A started <see cref="IGameHost"/> that hosts the application.</returns>
        public static IGameHost Start(RequestDelegate app) =>
        ...
        /// <param name="app">A delegate that handles requests to the application.</param>
        /// <returns>A started <see cref="IGameHost"/> that hosts the application.</returns>
        public static IGameHost Start(string url, RequestDelegate app)
        {
        ...
        /// <returns>A started <see cref="IGameHost"/> that hosts the application.</returns>
        public static IGameHost Start(Action<IRouteBuilder> routeBuilder) =>
        ...
        /// <param name="routeBuilder">A delegate that configures the router for handling requests to the application.</param>
        /// <returns>A started <see cref="IGameHost"/> that hosts the application.</returns>
        public static IGameHost Start(string url, Action<IRouteBuilder> routeBuilder)
        {
        ...
        /// <returns>A started <see cref="IGameHost"/> that hosts the application.</returns>
        public static IGameHost StartWith(Action<IApplicationBuilder> app) =>
        ...
        /// <param name="app">The delegate that configures the <see cref="IApplicationBuilder"/>.</param>
        /// <returns>A started <see cref="IGameHost"/> that hosts the application.</returns>
        public static IGameHost StartWith(string url, Action<IApplicationBuilder> app) =>
            StartWith(url: url, configureServices: null, app: app, applicationName: null);

        private static IGameHost StartWith(string url, Action<IServiceCollection> configureServices, Action<IApplicationBuilder> app, string applicationName)
        {
            ...
            if (!string.IsNullOrEmpty(applicationName))
                builder.UseSetting(GameHostDefaults.ApplicationKey, applicationName);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GameHostBuilder"/> class with pre-configured defaults.
        /// </summary>
        /// <remarks>
        ///   The following defaults are applied to the returned <see cref="GameHostBuilder"/>:
        ...
        /// </remarks>
        /// <returns>The initialized <see cref="IGameHostBuilder"/>.</returns>
        public static IGameHostBuilder CreateDefaultBuilder() =>
        ...
        /// <returns>The initialized <see cref="IGameHostBuilder"/>.</returns>
        public static IGameHostBuilder CreateDefaultBuilder(string[] args)
        {
            var builder = new GameHostBuilder();

            if (string.IsNullOrEmpty(builder.GetSetting(GameHostDefaults.ContentRootKey)))
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GameHostBuilder"/> class with pre-configured defaults using typed Startup.
        /// </summary>
        /// <remarks>
        ///   The following defaults are applied to the returned <see cref="GameHostBuilder"/>:
        ///     use Kestrel as the web server and configure it using the application's configuration providers,
        ...
        /// <param name="args">The command line args.</param>
        /// <returns>The initialized <see cref="IGameHostBuilder"/>.</returns>
        public static IGameHostBuilder CreateDefaultBuilder<TStartup>(string[] args) where TStartup : class =>
