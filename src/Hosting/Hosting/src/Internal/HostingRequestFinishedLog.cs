    ...
    internal class HostingRequestFinishedLog : IReadOnlyList<KeyValuePair<string, object>>
    {
        ...
        public KeyValuePair<string, object> this[int index]
        {
            get
            {
                switch (index)
                {
                    case 0: return new KeyValuePair<string, object>("ElapsedMilliseconds", _elapsed.TotalMilliseconds);
                    case 1: return new KeyValuePair<string, object>("StatusCode", _httpContext.Response.StatusCode);
                    case 2: return new KeyValuePair<string, object>("ContentType", _httpContext.Response.ContentType);
