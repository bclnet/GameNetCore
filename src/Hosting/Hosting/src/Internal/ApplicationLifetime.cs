...
#pragma warning restore CS0618 // Type or member is obsolete
    {
        ...
        readonly CancellationTokenSource _stoppingSource = new CancellationTokenSource();
        readonly CancellationTokenSource _stoppedSource = new CancellationTokenSource();
        readonly ILogger<ApplicationLifetime> _logger;
        ...
        void ExecuteHandlers(CancellationTokenSource cancel)
        {
