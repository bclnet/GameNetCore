...
namespace Contoso.GameNetCore.Client.Standard.Core.Internal.Infrastructure
{
    internal class StandardTrace : IStandardTrace
    {
        protected readonly ILogger _logger;

        public StandardTrace(ILogger logger)
        {
            _logger = logger;
        }
